...
function field_enumCustom($table = '', $field = '', $title = '')
{
    $enums = array();
    if ($table == '' || $field == '') return $enums;
    $db = \Config\Database::connect();
    ...
    foreach ($matches[1] as $key => $value) {
        if ($value == 1) {
            $enums[$value] = 'Belum diproses';
        } elseif ($value == 2) {
            $enums[$value] = 'Diproses';
        } elseif ($value == 3) {
            $enums[$value] = 'Dalam Perjalanan';
        } elseif ($value == 4) {
            $enums[$value] = 'Selesai';
        } else if ($value == 0) {
            $enums[$value] = 'Dibatalkan';
        }
    }
    return $enums;
}
